...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(windowSlotsObj){
	  ...
	  __webpack_require__(2).initialize(dataSources);
	  __webpack_require__(5)(dataSources, utils);
	  __webpack_require__(6).initialize(dataSources);
	  __webpack_require__(7)(dataSources, utils);
	  __webpack_require__(8).initialize(dataSources);
	  __webpack_require__(9)(dataSources, utils);
	  __webpack_require__(10).initialize(dataSources);
	  __webpack_require__(14)(dataSources, utils);
	  __webpack_require__(15).initialize(dataSources);
	  __webpack_require__(16)(dataSources, utils);
	  __webpack_require__(17).initialize(dataSources);
	  __webpack_require__(18)(dataSources, utils);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Equation = __webpack_require__(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Equation = __webpack_require__(4).default;
	...
	module.exports = function(dataSources, utils){
	  ...
	  var contentFactory = {
	    load : function(rerender){
	      var value = [];
	      var suppressRerender = false;
	      var accumulateTrans = dataSources.get("translations").get("accumulate");
	        ...
	        render : function(){
	          ...
	          var createButton = $("<input type='button' value='Create'></input>")
	            .click(function(){
	              ...
	              if(source){
	                accumulateTrans(source, dataSources, name);
	              }
	            });

	          return $("<span></span>")
	            .append($("<h3>Accumulate Transformation</h3>"))
	            .append($("<div></div>").append($("<span>Source: </span>")).append(sourceSelect))
	            .append($("<div></div>").append($("<span>Name: </span>")).append(renameField))
	            .append(createButton);
	  ...
	  dataSources.get("contentTypes").set("accumulate-translation", contentFactory);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(12)(module), (function() { return this; }()), __webpack_require__(13)))
